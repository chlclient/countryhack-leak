...
namespace G
{
	...
	inline bool      HasSavedPos = false;
	inline Vector    SavedPos = {};

	inline bool UpdatingAnims = false;
	inline bool FlipViewmodels = false;

	struct MovementRecord_t
	{
		float forwardmove;
		float sidemove;
		float upmove;
	...
	static RecorderState_t g_RecorderState = RecorderState_t::Idle;
	static std::vector<MovementRecord_t> g_Records;
	static Vec3 g_vRecordStartPos = {};
	static size_t g_nPlaybackIndex = 0;
